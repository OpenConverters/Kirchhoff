// pshb_demo — build the PSFB TAS, emit the ideal ngspice deck, run it, print Vout.
...
static std::string run_ngspice(const std::string& deck, const std::string& tag) {
    const std::string path = "/tmp/pshb_demo_" + tag + ".cir";
