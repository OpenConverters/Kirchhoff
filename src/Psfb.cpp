...
json build_psfb_tas(const PsfbDesign& d) {
    ...
    // (peak Vs); CENTER_TAPPED blocks 2·Vs (both half-windings in series) and VOLTAGE_DOUBLER blocks
    // 2·Vs (winding + the stacked reservoir cap). Each carries the output current while conducting.
    // REAL rectifiers -> req::diode.
